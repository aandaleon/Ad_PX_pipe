...
parser.add_argument("--MESA_prefix", type = str, action = "store", dest = "MESA_prefix", required = False, default = "/media/MyBook/lauren/files_for_revisions_plosgen/en_v7/dbs/", help = "Path to prefix of all MESA models. Default = /home/lauren/files_for_revisions_plosgen/en_v7/dbs/")
